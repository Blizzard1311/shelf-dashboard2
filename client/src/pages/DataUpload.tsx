import { Upload, FileSpreadsheet, Clock, Wrench } from "lucide-react";
  ...
  return (
    <div className="p-4 lg:p-6 h-full flex flex-col">
      ...
      <div className="mb-6">
        ...
        <p className="text-sm text-muted-foreground ml-12">上传并管理货架数据文件</p>
      </div>
        ...
        <div className="text-center max-w-md">
          ...
          <div className="relative mx-auto mb-6 w-24 h-24">
            <div
              ...
              style={{
                background: "linear-gradient(135deg, oklch(0.55 0.18 260 / 0.12), oklch(0.50 0.20 280 / 0.08))",
                border: "2px dashed oklch(0.55 0.18 260 / 0.3)",
              }}
            >
              <Upload className="w-10 h-10" style={{ color: "oklch(0.55 0.18 260)" }} />
            </div>
            <div
          ...
          <p className="text-sm text-muted-foreground mb-6 leading-relaxed">
            数据上传模块正在开发中，即将支持 CSV、Excel、JSON 等多种格式的数据文件导入与管理。
          </p>
          ...
          <div
            ...
            style={{
              ...
              border: "1px solid oklch(0.55 0.18 260 / 0.15)",
            }}
          >
            ...
            {[
              { icon: FileSpreadsheet, text: "支持 CSV / Excel / JSON 格式上传" },
              { icon: Upload, text: "拖拽上传与批量导入" },
              { icon: Clock, text: "上传历史记录与版本管理" },
            ].map((item, i) => {
              ...
              return (
                <div key={i} className="flex items-center gap-2.5">
                  ...
                  >
                    <Icon className="w-3.5 h-3.5" style={{ color: "oklch(0.55 0.18 260)" }} />
                  </div>
