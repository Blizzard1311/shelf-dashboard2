...
describe("TEMPLATE_FIELDS", () => {
  it("应包含 14 个字段", () => {
    expect(TEMPLATE_FIELDS).toHaveLength(14);
  });
...
describe("upload parse logic", () => {
  it("字段完整且有数据时解析成功", () => {
    const rows = [
      { 大类: "A", 中类: "B", 小类: "C", 子类: "D", 商品编码: "P001", 商品名称: "商品1", 货架编码: "S01", 货架层数: 3, 储位编码: "S01-1", 陈列面数: 2, 陈列层数: 1, 单层层数: 4, 销售数量: 10, 销售金额: 100 },
      { 大类: "A", 中类: "B", 小类: "C", 子类: "D", 商品编码: "P002", 商品名称: "商品2", 货架编码: "S01", 货架层数: 3, 储位编码: "S01-2", 陈列面数: 2, 陈列层数: 1, 单层层数: 4, 销售数量: 20, 销售金额: 200 },
      { 大类: "A", 中类: "B", 小类: "C", 子类: "D", 商品编码: "P003", 商品名称: "商品3", 货架编码: "S02", 货架层数: 3, 储位编码: "S02-1", 陈列面数: 2, 陈列层数: 1, 单层层数: 4, 销售数量: 15, 销售金额: 150 },
    ];
